...
// form renders
$render_upload_form  = $view->render( 'MauticLeadBundle:Import:upload_form.html.php', ['form' => $form] );
$render_mapping_form = $view->render( 'MauticLeadBundle:Import:mapping_form.html.php', ['form' => $form] );
...
if ( $object === 'contacts' ) {
    ...
    if ( $contactsCount < $package_limit ):
        if ( isset( $form['file'] ) ):
            echo $render_upload_form;
        else:
            echo $render_mapping_form;
        endif;
    else: ?>
        <div class="row">
